...
def propose_feature_specs(call: SkillCall, context: ExecutionContext) -> SkillResult:
    specs = [
        ...
        {"feature_family": "strict_statistical_history", "availability": "repair_evidence_required",
        ...
        {"feature_family": "short_sequence", "availability": "gpu_experiment_not_run",
         "examples": ["last_k_event_embeddings", "masked_time_gaps"],
         "point_in_time_rule": "strict prefix; no target feedback"},
        {"feature_family": "long_sequence", "availability": "gpu_experiment_not_run",
    ...
    payload = {
        ...
        "feature_specs": specs,
        "promotion_status": "blocked_pending_verified_probability_and_sequence_evidence",
...
def review_claim_boundaries(call: SkillCall, context: ExecutionContext) -> SkillResult:
    ...
    if highest is EvidenceTier.NONE:
        missing += ["verified model-comparison predictions", "frozen gate verdicts", "GPU experiment manifest"]
